package com.android.alen.mybasicproject.greendao.gen;
...
import com.android.alen.mybasicproject.DBUntiy.Book;
...
public class BookDao extends AbstractDao<Book, Void> {
    ...
    public static class Properties {
        ...
        public final static Property Alt_title = new Property(3, String.class, "alt_title", false, "ALT_TITLE");
        public final static Property Author_intro = new Property(4, String.class, "author_intro", false, "AUTHOR_INTRO");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BOOK\" (" + //
                ...
                "\"TITLE\" TEXT," + // 1: title
                "\"URL\" TEXT," + // 2: url
                "\"ALT_TITLE\" TEXT," + // 3: alt_title
                "\"AUTHOR_INTRO\" TEXT," + // 4: author_intro
    ...
    public Book readEntity(Cursor cursor, int offset) {
        Book entity = new Book( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // alt_title
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // author_intro
    ...
    public void readEntity(Cursor cursor, Book entity, int offset) {
        ...
        entity.setAlt_title(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        entity.setAuthor_intro(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
