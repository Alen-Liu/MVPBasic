...
public class EventCenterManager {
    ...
    private static SparseArray<Set<OnHandleEventListener>> sMap = new SparseArray<Set<OnHandleEventListener>>();
    ...
    public static void addEventListener(final int event,
        ...
        if (onHandleEventListener != null) {
            synchronized (sMap) {
                ...
                if (set == null) {
                    set = new HashSet<OnHandleEventListener>();
                    sMap.put(event, set);
                }
    ...
    public interface OnHandleEventListener {
        public void onHandleEvent(final EventMessage eventMessage);
    }
